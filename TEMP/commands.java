            ...
            if (cmd.getName().equalsIgnoreCase("bp")) {
            	...
            	if (args.length == 0) {
            		...
            		if (args[0].equalsIgnoreCase("help")) {
            			...
            			public static addedTo {
            				
            				
            					p.sendMessage(Main.prefix + ChatColor.DARK_AQUA + "Added " + Main.mater + "To " + Main.inv);
                				p.getInventory().addItem(ItemStack(Material.getMaterial(Main.mater)));
                				Main.mater = null;
            			}
            			...
            			if (Material.matchMaterial(args[1].toUpperCase()) != null) {
            				...
            				if (args[2].equalsIgnoreCase("plains")) {
            					...
            					Main.config.addDefault("plains", args[2] + args[3]);
            					p.sendMessage(Main.prefix + ChatColor.DARK_AQUA + "Added " + Main.mater + "To " + Main.inv);
                				p.getInventory().addItem(ItemStack(Material.getMaterial(Main.mater)));
                				Main.mater = null;
